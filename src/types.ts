...
export interface FontMixSaveFile {
  app: "FontMix Studio";
  version: 1;
  savedAt: string;
  name: string;
  ...
  globalTextAlign: "left" | "center" | "right" | "justify";
  globalVerticalAlign: "top" | "center" | "bottom";
  customKoreanFonts: FontMetadata[];
  customEnglishFonts: FontMetadata[];
}
